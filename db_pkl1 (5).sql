...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 16, 2014 at 09:34 AM
...
(112, 'Kepala'),
(108, 'Kepala Bagian Administrasi Kemasyarakatan dan Pemb'),
(109, 'Kepala Bagian Administrasi Kesejahteraan Rakyat'),
(102, 'Kepala Bagian Administrasi Pembangunan'),
(106, 'Kepala Bagian Hubungan Masyarakat'),
(99, 'Kepala Bagian Hukum'),
(101, 'Kepala Bagian Kerjasama Setda'),
(107, 'Kepala Bagian Organisasi Setda'),
(103, 'Kepala Bagian Pengelola Data Elektronik'),
(100, 'Kepala Bagian Perekonomian'),
(98, 'Kepala Bagian Pertanahan'),
(97, 'Kepala Bagian Tata Pemerintahan Desa'),
(96, 'Kepala Bagian Tata Pemerintahan Umum'),
(105, 'Kepala Bagian Tata Usaha'),
(104, 'Kepala Bagian Umum Dan Protokol'),
...
CREATE TABLE IF NOT EXISTS `tbl_pangkat_gol` (
  `kd_pg` int(10) NOT NULL AUTO_INCREMENT,
...
('PNS0007', '19611023 198401 1 002', 'Drs. EDY SUSANTO, M.Si', 97, 13, NULL),
('PNS0008', '19570830 198209 1 020', 'Drs. MARDIYANTO', 98, 11, NULL),
('PNS0009', '19710414 199403 1 007', 'SUBUR HUTAGALUNG, SH. M.Hum', 99, 13, NULL),
('PNS0010', '19681107 198903  1 008', 'RACHMAT HARDIJONO, S.Sos., M.Si', 100, 14, NULL),
('PNS0011', '3', 'Drs. ABDUL HARIS, M.Si', 101, 12, NULL),
...
('PNS0014', '3', 'Dr.BUDIAR, M.Si', 104, 9, NULL),
('PNS0015', '4', 'ANISWATY AZIZ , SE, M.Si', 105, 8, NULL),
('PNS0016', '4', 'Drs.M.HIDAYAT, MM,M.Pd', 106, 12, NULL),
('PNS0017', '2', 'Drs. NANDANG DJUMANTARA', 107, 10, NULL),
('PNS0018', '4', 'NURHASYIM, SH, M.Si', 108, 10, NULL),
('PNS0019', '3', 'Ir. R. TAUFIQ HIDAYAT', 109, 9, NULL),
...
INSERT INTO `tbl_sppd` (`no_surat`, `kd_sdm`, `pengikut1`, `pengikut2`, `pengikut3`, `uang_saku`, `tgl_berangkat`, `tgl_kembali`, `lama`, `untuk`, `dari`, `ke`, `transportasi`, `atas_beban`, `pasal_anggaran`, `keterangan`, `tanggal_surat`, `status`, `pejabat`, `kode_skpd`) VALUES
('094/1/421.024/2014', 'PNS0013', 'PNS0006', 'PNS0037', 'PNS0012', 0, '2014-11-11', '0000-00-00', '2', 'NGISENG BERSAMA dalam rangkat hari ulang tahun Bhoci.NGISENG BERSAMA dalam rangkat hari ulang tahun Bhoci.NGISENG BERSAMA dalam rangkat hari ulang tahun Bhoci.NGISENG BERSAMA dalam rangkat hari ulang tahun Bhoci.', 'Malang', 'Blitar', 'Kereta Api', '-', '-', '-', '2014-11-09', 'PNS00139102014', 'PNS0003', '421.024'),
('094/122/421.024/2014', 'PNS0013', 'PNS0037', 'PNS0012', '', 0, '2014-11-13', '2014-11-14', '2', 'Pakai Surat Dasar (Surat berdasarkan surat balasan). Pakai Surat Dasar (Surat berdasarkan surat balasan). Pakai Surat Dasar (Surat berdasarkan surat balasan).Pakai Surat Dasar (Surat berdasarkan surat balasan). Pakai Surat Dasar (Surat berdasarkan surat balasan). Pakai Surat Dasar (Surat berdasarkan surat balasan). ', 'Malang', 'surabaya', 'Sepeda Motor', '', '', '', '2014-11-13', 'PNS001313102014', 'PNS0003', '421.024'),
('094/12312/421.024/2014', 'PNS0013', 'PNS0006', 'KON0001', '', 1000000, '2014-12-17', '2014-12-19', '3', 'Tidak memakai Surat Dasar (Diisi sebagai pembuka surat). Tidak memakai Surat Dasar (Diisi sebagai pembuka surat). Tidak memakai Surat Dasar (Diisi sebagai pembuka surat).Tidak memakai Surat Dasar (Diisi sebagai pembuka surat).', 'Malang', 'Jakarta', 'Mobil', '', '', '', '2014-12-16', 'PNS001316112014', 'PNS0003', '421.024'),
('094/2/421.024/2014', 'KON0001', '', '', '', 0, '2014-11-10', '0000-00-00', '2', 'Pakai Surat Dasar (Surat berdasarkan surat balasan). Pakai Surat Dasar (Surat berdasarkan surat balasan). Pakai Surat Dasar (Surat berdasarkan surat balasan).Pakai Surat Dasar (Surat berdasarkan surat balasan). Pakai Surat Dasar (Surat berdasarkan surat balasan).Pakai Surat Dasar (Surat berdasarkan surat balasan).', 'Malang', 'Surabaya', 'Bus Umum', '-', '-', '-', '2014-11-09', 'KON00019102014', 'PNS0013', '421.024'),
('094/444/421.024/2014', 'PNS0037', 'PNS0012', '', '', 100000, '2014-12-17', '2014-12-18', '2', 'Pakai Surat Dasar (Surat berdasarkan surat balasan). Pakai Surat Dasar (Surat berdasarkan surat balasan). Pakai Surat Dasar (Surat berdasarkan surat balasan). Pakai Surat Dasar (Surat berdasarkan surat balasan).', 'Malang', 'Surabaya', 'Sepeda Motor', '', '', '', '2014-12-16', 'PNS003716112014', 'PNS0013', '421.024'),
('094/6/421.024/2014', 'PNS0013', 'KON0001', '', '', 0, '2014-11-12', '0000-00-00', '2', 'Tidak memakai Surat Dasar (Diisi sebagai pembuka surat).Tidak memakai Surat Dasar (Diisi sebagai pembuka surat). ', 'Malang', 'Surabaya', 'Sepeda Motor', '', '', '', '2014-11-10', 'PNS001310102014', 'PNS0003', '421.024');
...
('094/1/421.024/2014', 'PNS0013', 'PNS0006', 'PNS0037', 'PNS0012', '2014-11-09', 'NGISENG BERSAMA dalam rangkat hari ulang tahun Bhoci.NGISENG BERSAMA dalam rangkat hari ulang tahun Bhoci.NGISENG BERSAMA dalam rangkat hari ulang tahun Bhoci.NGISENG BERSAMA dalam rangkat hari ulang tahun Bhoci.', '', 'Tidak memakai Surat Dasar (Diisi sebagai pembuka surat). Tidak memakai Surat Dasar (Diisi sebagai pembuka surat). Tidak memakai Surat Dasar (Diisi sebagai pembuka surat).', 'PNS00139102014', 'PNS0003', '421.024'),
('094/122/421.024/2014', 'PNS0013', 'PNS0037', 'PNS0012', '', '2014-11-13', 'Pakai Surat Dasar (Surat berdasarkan surat balasan). Pakai Surat Dasar (Surat berdasarkan surat balasan). Pakai Surat Dasar (Surat berdasarkan surat balasan).Pakai Surat Dasar (Surat berdasarkan surat balasan). Pakai Surat Dasar (Surat berdasarkan surat balasan). Pakai Surat Dasar (Surat berdasarkan surat balasan). ', 'Pakai Surat Dasar (Surat berdasarkan surat balasan). Pakai Surat Dasar (Surat berdasarkan surat balasan). Pakai Surat Dasar (Surat berdasarkan surat balasan)', '', 'PNS001313102014', 'PNS0003', '421.024'),
('094/12312/421.024/2014', 'PNS0013', 'PNS0006', 'KON0001', '', '2014-12-16', 'Tidak memakai Surat Dasar (Diisi sebagai pembuka surat). Tidak memakai Surat Dasar (Diisi sebagai pembuka surat). Tidak memakai Surat Dasar (Diisi sebagai pembuka surat).Tidak memakai Surat Dasar (Diisi sebagai pembuka surat).', '', 'Tidak memakai Surat Dasar (Diisi sebagai pembuka surat). Tidak memakai Surat Dasar (Diisi sebagai pembuka surat). Tidak memakai Surat Dasar (Diisi sebagai pembuka surat). ', 'PNS001316112014', 'PNS0003', '421.024'),
('094/2/421.024/2014', 'KON0001', '', '', '', '2014-11-09', 'Pakai Surat Dasar (Surat berdasarkan surat balasan). Pakai Surat Dasar (Surat berdasarkan surat balasan). Pakai Surat Dasar (Surat berdasarkan surat balasan).Pakai Surat Dasar (Surat berdasarkan surat balasan). Pakai Surat Dasar (Surat berdasarkan surat balasan).Pakai Surat Dasar (Surat berdasarkan surat balasan).', 'Pakai Surat Dasar (Surat berdasarkan surat balasan).Pakai Surat Dasar (Surat berdasarkan surat balasan). Pakai Surat Dasar (Surat berdasarkan surat balasan).', '', 'KON00019102014', 'PNS0013', '421.024'),
('094/444/421.024/2014', 'PNS0037', 'PNS0012', '', '', '2014-12-16', 'Pakai Surat Dasar (Surat berdasarkan surat balasan). Pakai Surat Dasar (Surat berdasarkan surat balasan). Pakai Surat Dasar (Surat berdasarkan surat balasan). Pakai Surat Dasar (Surat berdasarkan surat balasan).', 'Pakai Surat Dasar (Surat berdasarkan surat balasan). Pakai Surat Dasar (Surat berdasarkan surat balasan). Pakai Surat Dasar (Surat berdasarkan surat balasan). ', '', 'PNS003716112014', 'PNS0013', '421.024'),
('094/6/421.024/2014', 'PNS0013', 'KON0001', '', '', '2014-11-10', 'Tidak memakai Surat Dasar (Diisi sebagai pembuka surat).Tidak memakai Surat Dasar (Diisi sebagai pembuka surat). ', '', 'Tidak memakai Surat Dasar (Diisi sebagai pembuka surat).', 'PNS001310102014', 'PNS0003', '421.024');
