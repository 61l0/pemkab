...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 10, 2015 at 10:53 AM
...
CREATE TABLE IF NOT EXISTS `tbl_admin` (
  ...
  PRIMARY KEY (`no`),
  UNIQUE KEY `kode_skpd_2` (`kode_skpd`),
...
('PNS0042', '2398918453485934', 'Axxxx, S.pd', 112, 3, '421.102'),
('PNS0043', '2434589345', 'KHGFSAJF, S,kom', 111, 5, '421.102'),
('PNS0044', '20569385yu69824', 'kahjfkajknkjnadf', 112, 5, '421.108'),
('PNS0045', '273y49283', 'akfjkgaj', 111, 6, '421.108'),
('PNS0046', '4o8394', 'kajfkajfa', 112, 11, '421.034'),
('PNS0047', '938493843', 'ajkfkajf', 111, 9, '421.034'),
...
('094/12/421.024/2015', 'PNS0037', '', '', '', 0, '0000-00-00', '0000-00-00', '1', '', 'Malang', '', '', '-', '-', '-', '2015-01-05', 'PNS0037502015', 'PNS0013', '421.024'),
('094/13/421.024/2015', 'PNS0013', '', '', '', 124434, '2015-01-05', '2015-01-06', '2', 'Tidak memakai Surat Dasar (Diisi sebagai pembuka surat).Tidak memakai Surat Dasar (Diisi sebagai pembuka surat).Tidak memakai Surat Dasar (Diisi sebagai pembuka surat).', 'Malang', 's', 'Sepeda Motor', '-', '-', '-', '2015-01-05', 'PNS0013502015', 'PNS0002', '421.024');
...
('094/12/421.024/2015', 'PNS0037', '', '', '', '2015-01-05', '', NULL, NULL, 'PNS0037502015', 'PNS0013', '421.024'),
('094/13/421.024/2015', 'PNS0013', '', '', '', '2015-01-05', 'Tidak memakai Surat Dasar (Diisi sebagai pembuka surat).Tidak memakai Surat Dasar (Diisi sebagai pembuka surat).Tidak memakai Surat Dasar (Diisi sebagai pembuka surat).', '', 'Tidak memakai Surat Dasar (Diisi sebagai pembuka surat). Tidak memakai Surat Dasar (Diisi sebagai pembuka surat).', 'PNS0013502015', 'PNS0002', '421.024');
