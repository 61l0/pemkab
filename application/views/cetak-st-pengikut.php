...
<div class="page" style="font-size:14px;">
        ...
        <table  height="383" border="0" id="table-isi" width="auto" rules="none" style="font-size:16px">
              <tr>
                <td height="106" colspan="13" align="center"><img src="<?php echo base_url(); ?>assets/img/Logo-Pemkab-Malang.png" alt="kop" width="87" height="100" align="left" id="img" style="" /> <span  style="font-size:22px;">PEMERINTAH KABUPATEN MALANG</span><br/>
                    <?php 
    ...
    echo ("-");
             ...
             <tr>
               ...
               <td>Jabatan</td>
               <td>:</td>
               <td colspan="5"> <?php echo  $jabatan.' '.$nama_skpd; ?></td>
          </tr>             
             <?php 
			 	//query pengikut 1
		...
		?>
           ...
           <tr>
             ...
             <td>&nbsp;</td>
             <td>&nbsp;</td>
             <td colspan="3"><div align="center"><strong><?php echo $jabatan_pejabat; ?></strong></div></td>
          </tr>
           <tr>
             <td>&nbsp;</td>
             <td>&nbsp;</td>
