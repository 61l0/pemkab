...
<div class="book" id="PrintElem">
   <div class="page" style="font-size:14px;padding:0px;margin-right: -28px;">
        <div class="subpage">
            <table  height="383" border="0" id="table-isi" width="100%" rules="all" style="border-collapse:collapse">
        <tr>
